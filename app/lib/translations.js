const translations = {
  EN: {
    ...
    how_to: "① Enter your preferences · ② Paste job URLs or descriptions below · ③ Hit LET'S CHECK to get your compatibility scores",
  ...
  FR: {
    ...
    how_to: "① Entre tes préférences · ② Colle des liens ou descriptions · ③ Clique VÉRIFIONS pour voir tes scores de compatibilité",
  ...
  CH: {
    ...
    analyzer: "職位適配度分析 ✦",
    panel_title: "來！ ☞ 開始分析",
    how_to: "① 輸入你的偏好關鍵字 · ② 貼上職位連結或描述 · ③ 點擊檢查開始取得你的適配分數",
    preference: "偏好",
